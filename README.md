...
Run `build` to build the project with coordinated env variables. The build artifacts will be stored in the `build/` directory.
...
## Static types generation
```shell script
npx dtsgenerator --out src/@types/types.d.ts --url https://ingw.viettelpost.vn/swagger/index.html?url=/swagger/v1/swagger.json
npx dtsgenerator --out src/@types/types-sso.d.ts --url https://prigateway.viettelpost.vn/swagger/index.html?url=/swagger/v1/swagger.json
```
