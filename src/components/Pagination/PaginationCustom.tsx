...
interface Props extends ReactPaginateProps {
  ...
  buttonPaginationEdit?: JSX.Element;
}
...
function Pagination(props: Props): JSX.Element {
  ...
  return (
    <nav className="sipPagination sipPaginationCustom">
      <div className="sipPaginationTotal" style={{ marginRight: 20 }}>
      ...
      <ReactPaginate
        ...
        {...props}
      />
      <div className="btnPaginationCustom">
        {props.buttonPaginationEdit ? props.buttonPaginationEdit : ''}
        {/* <Button color="primary">Hủy</Button>
        <Button
          className="sipPaginationTotalLast"
          color="primary"
          onClick={() => {
            console.log('akjsdjkash');
          }}
        >
          Duyệt
        </Button> */}
