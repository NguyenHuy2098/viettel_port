      ...
      <div className="animated fadeIn">
        <Row>
          ...
          <Col xs="12" md="6" className="mb-4">
            ...
            <TabContent activeTab={this.state.activeTab[1]}>{this.tabPane()}</TabContent>
          </Col>
          <Col xs="12" md="6" className="mb-4">
            <Nav tabs>
              <NavItem>
              ...
              <NavItem>
                ...
                >
                  <i className="icon-basket-loaded"></i>{' '}
                  <span className={this.state.activeTab[2] === '2' ? '' : 'd-none'}> Shopping cart</span>
                </NavLink>
              </NavItem>
              <NavItem>
                <NavLink
            ...
            <TabContent activeTab={this.state.activeTab[2]}>{this.tabPane()}</TabContent>
          </Col>
          <Col xs="12" md="6" className="mb-4">
            <Nav tabs>
              <NavItem>
            ...
            <TabContent activeTab={this.state.activeTab[3]}>{this.tabPane()}</TabContent>
          </Col>
        </Row>
      </div>
    );
