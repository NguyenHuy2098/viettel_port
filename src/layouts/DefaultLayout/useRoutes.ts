...
const BangKeChuaHoanThanh = Loadable({
  loader: (): any => import('containers/KhaiThacDi/DongBangKe/BangKeChuaHoanThanh'),
  loading: Loading,
});
...
const routes = (t: i18next.TFunction): SIPRoutePropsType[] => {
  return [
    ...
    { path: routesMap.dongBangKe, name: t('Đóng bảng kê'), component: BangKeChuaHoanThanh },
