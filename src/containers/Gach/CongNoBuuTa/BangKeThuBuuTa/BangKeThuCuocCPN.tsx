...
import DetailThuCuocCPN from './DetailThuCuocCPN';
import ModalAddBangkeThuCuocCPN from './ModalAddBangkeThuCuocCPN';

const BangKeThuCuocCPN = (): JSX.Element => {
    ...
    <>
      ...
      {hideDetail === true ? (
        <div className="mb-3 sipTableContainer sipTableRowClickable row" ref={refDetaiBangKeCod}>
          <DetailThuCuocCPN toggle={toggle} handleDeleteItem={handleDeleteItem} />
        </div>
      ) : (
        ''
      )}
      ...
      >
        <ModalAddBangkeThuCuocCPN toggle={toggle} />
      </Modal>
      <ModalConfirmDelete
...
export default BangKeThuCuocCPN;
